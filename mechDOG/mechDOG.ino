...
void stateMachine()
{
  ...
  if (radio.available())
    { 
      ...
      if (data.joystickY <= 255 && data.buttonBLUE == 0) // trot_F()
        {
          if (prevState == 1)
            {
              state = 1; 
      ...
      else if (data.joystickX <= 255 && data.buttonBLUE == 0) // trot_R()
        {
          if (prevState == 3)
            {
              state = 3; 
      ...
      else if (data.joystickX >= 767 && data.buttonBLUE == 0) // trot_L()
        {
          if (prevState == 4)
            {
              state = 4; 
      ...
      else if (data.joystickBUTTON == 0 && data.buttonBLUE == 0) // trot_P()
        {
          if (prevState == 5)
            {
              state = 5; 
      ...
      else if (data.joystickX <= 255 && data.buttonRED == 0) // turn_R()
        {
          if (prevState == 6)
            {
              state = 6; 
      ...
      else if (data.joystickX >=767 && data.buttonRED == 0) // turn_L()
        {
          if (prevState == 7)
            {
              state = 7; 
      ...
      else if (data.joystickY >=767 && data.buttonYELLOW == 0) // look_U()
        {
          if (prevState == 8)
            {
              state = 8; 
